...
return new class extends Migration
{
    ...
    {
        Schema::create('ibl_plr__test', function (Blueprint $table) {
            $table->integer('HOF')->default(0);
            ...
            $table->string('fgpct', 8);
            $table->integer('poschange')->default(0);
            $table->primary('pid');
            $table->index('pid');
        });
    }
    ...
    {
        Schema::dropIfExists('ibl_plr__test');
    }
};
