...
class CreateIblTeamDefenseStatsTable extends Migration
{
    public function up()
    {
        Schema::create('ibl_team_defense_stats', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ibl_team_defense_stats');
    }
}